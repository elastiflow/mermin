...
fn try_mermin(ctx: TcContext, direction: Direction) -> (TcContext, Result<i32, ()>) {
    ...
    for _ in 0..MAX_HEADER_PARSE_DEPTH {
        let result: Result<(), Error> = match parser.next_hdr {
            ...
            HeaderType::ErrorOccurred => return (ctx, Ok(TC_ACT_PIPE)), // Error, pass packet
        };
...
mod tests {
    ...
    //     // Call try_mermin and get the result
