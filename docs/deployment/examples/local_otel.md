...
* [Mermin with OpenTelemetry Collector](local_otel.md#mermin-with-opentelemetry-collector)
  * [Overview](local_otel.md#overview)
  * [Install](local_otel.md#install)
    * [Debug charts](local_otel.md#debug-charts)
...
* Create a values file for the OTEL Collector with [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/local_otel/values_otel.yaml) or use one from the repo
*   Deploy the OTEL Collector chart
    ...
    ```
* Create config file for the Mermin with [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/local_otel/config.hcl) or use one from the repo
