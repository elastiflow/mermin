...
* [Mermin with NetObserv Flow and OpenSearch in GKE with Gateway](netobserv_os_simple_gke_gw.md#mermin-with-netobserv-flow-and-opensearch-in-gke-with-gateway)
  * [Overview](netobserv_os_simple_gke_gw.md#overview)
  * [Install](netobserv_os_simple_gke_gw.md#install)
  * [Access](netobserv_os_simple_gke_gw.md#access)
  * [Hints](netobserv_os_simple_gke_gw.md#hints)
...
* Phase 1
  * Create values and a config files for the Mermin Umbrella chart (or use ones from the repo)
    * Values [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/netobserv_os_simple_gke_gw/values.yaml)
    * Config [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/netobserv_os_simple_gke_gw/config.hcl)
