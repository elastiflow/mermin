...
* [Mermin with NetObserv Flow and OpenSearch](netobserv_os_simple_svc.md#mermin-with-netobserv-flow-and-opensearch)
  * [Overview](netobserv_os_simple_svc.md#overview)
  * [Install](netobserv_os_simple_svc.md#install)
  * [Access](netobserv_os_simple_svc.md#access)
  * [Hints](netobserv_os_simple_svc.md#hints)
...
* Create values and a config file for the Mermin Umbrella chart (or use ones from the repo)
  * Values [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/netobserv_os_simple_svc/values.yaml)
  * Config [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/netobserv_os_simple_svc/config.hcl)
