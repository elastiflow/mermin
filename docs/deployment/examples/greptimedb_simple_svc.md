...
* [Mermin with GreptimeDB](greptimedb_simple_svc.md#mermin-with-greptimedb)
  * [Overview](greptimedb_simple_svc.md#overview)
  * [Install](greptimedb_simple_svc.md#install)
    * [GreptimeDB](greptimedb_simple_svc.md#greptimedb)
    * [Mermin](greptimedb_simple_svc.md#mermin)
  * [Access](greptimedb_simple_svc.md#access)
  * [Debug charts](greptimedb_simple_svc.md#debug-charts)
...
* Create a values file for GreptimeDB with [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/greptimedb_simple_svc/values_greptime.yaml) or use one from the repo, which includes configurations to receive Mermin metrics.
...
* Create a `config.hcl` file with [contents](https://github.com/elastiflow/mermin/blob/beta/docs/deployment/examples/greptimedb_simple_svc/config.hcl), or use the one from the repo. Modify as desired, but retain the `export.traces.otlp.headers` and `export.traces.otlp.protocol` sections.
