...
- [ ] Review [Architecture](../architecture.md) to understand how Mermin works
- [ ] Choose appropriate [deployment method](README.md#deployment-options)
- [ ] Plan [resource allocation](README.md#resource-requirements)
