...
* [Configuration References](configuration/configuration-references/README.md)
  * [Configure Network Interface Discovery](configuration/configuration-references/network-interface-discovery.md "Network Interface Discovery")
  * [Configure the Network Packet Parser](configuration/configuration-references/network-packet-parser.md "Network Packet Parser")
