...
**Example Configuration:** See [Mermin with OpenTelemetry Collector](../deployment/examples/local_otel.md) for a complete setup with OpenTelemetry Collector, including Mermin configuration and collector pipeline.
...
**Example:** See [`docs/deployment/examples/netobserv_os_simple_svc/`](../deployment/examples/netobserv_os_simple_svc.md) for OpenSearch (Elastic-compatible) deployment
...
* [`docs/deployment/examples/netobserv_os_simple_svc/`](../deployment/examples/netobserv_os_simple_svc.md) - Basic OpenSearch setup
* [`docs/deployment/examples/netobserv_os_simple_gke_gw/`](../deployment/examples/netobserv_os_simple_gke_gw.md) - GKE deployment with Gateway API
...
**Example:** [`docs/deployment/examples/greptime_simple_svc`](../deployment/examples/greptimedb_simple_svc.md)
...
3. **Configure OTLP export** in your Mermin deployment – see [OTLP Exporter Configuration](../configuration/reference/export-otlp.md)
4. **Set up authentication and TLS** for production – see [OTLP Exporter Configuration](../configuration/reference/export-otlp.md)
