...
mod tests {
    ...
    fn test_next_hdr() {
        ...
        fragment.set_next_hdr(IpProto::Stream); // Example: ICMPv6
        assert_eq!(fragment.next_hdr(), IpProto::Stream);
        assert_eq!(fragment.next_hdr, IpProto::Stream);
    }
    ...
    fn test_combined_fields() {
        ...
        // Set all fields
        fragment.set_next_hdr(IpProto::Stream); // ICMPv6
        fragment.set_reserved(123);
        ...
        fragment.set_next_hdr(IpProto::Stream); // TCP
        assert_eq!(fragment.next_hdr(), IpProto::Stream);
        ...
        assert_eq!(fragment.next_hdr(), IpProto::Stream); // Should remain unchanged
        assert_eq!(fragment.reserved(), 255);
        assert_eq!(fragment.fragment_offset(), 0x0DEF); // Should remain unchanged
        assert_eq!(fragment.reserved2(), 1); // Should remain unchanged
        assert_eq!(fragment.m_flag(), false); // Should remain unchanged
